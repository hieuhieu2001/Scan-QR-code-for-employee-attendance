...
class MainActivity : AppCompatActivity() {
    ...
    private fun getTime()
    {
        ...
        val currentDay = SimpleDateFormat(" dd ' - ' MM ' - ' yyyy", Locale.getDefault()).format(Date())
    ...
    private fun getDelay()
    {
        Handler(Looper.getMainLooper()).postDelayed({        // su dung handler de doi mot khoang thoi gian va sau do chuyen sang man hinh khac
            val intent = Intent(this, Home::class.java)            // tao intent de chuyen sang man hinh khac
